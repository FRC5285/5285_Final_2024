...
public class RobotContainer {
        ...
        public RobotContainer() { // Note for future coder: Order matters when you pass suppliers to get function
                                  // data, must match instantiation order in SwerveJoystickCmd
                swerveSubsystem.setDefaultCommand(new SwerveJoystickCmd(
                                ...
                                () -> controller2.getYButton(), // Shoots Intake
                                () -> controller2.getXButton(), // Vacuum Intake
                                () -> controller2.getBButton(), // Arm and Wrist Low Score Angle
                                () -> controller2.getAButton(), // Arm and Wrist Pick Up Angle
                                () -> controller2.getBackButton(), // Arm and Wrist Feed Angle
                                () -> controller1.getLeftBumper(), // Climber Up
        ...
        private void configureButtonBindings() {
                new JoystickButton(controller1, XboxController.Button.kRightBumper.value)
                                .whileTrue(flyWheel.getShootCommand());

                intake.setDefaultCommand(new IntakeCmd(intake, controller1::getLeftTriggerAxis,
                                controller1::getRightTriggerAxis));
        }

        ////////////// LIST OF AUTON CODES///////////////////LIST OF AUTON
        ////////////// CODES///////////////////LIST OF AUTON CODES/////////////
        ...
        public Command getBlueLeft3HighAutonomousCommand() {
                ...
                // 2. Generate trajectory (Note: I can add interior waypoints, but everytime I
                // need a new angle orientation, I need to concatinate trajecotries as
                // trejectory is not modified in interior waypoints)
                ...
                try {
                        ...
                        // Path trajectoryPath2 =
                        // Filesystem.getDeployDirectory().toPath().resolve(trajectoryJSON2);
                        // Path trajectoryPath3 =
                        // Filesystem.getDeployDirectory().toPath().resolve(trajectoryJSON3);
                        // Path trajectoryPath4 =
                        // Filesystem.getDeployDirectory().toPath().resolve(trajectoryJSON4);
                        // Path trajectoryPath5 =
                        // Filesystem.getDeployDirectory().toPath().resolve(trajectoryJSON5);
                        // Path trajectoryPath6 =
                        // Filesystem.getDeployDirectory().toPath().resolve(trajectoryJSON6);
                ...
                List<Trajectory> trajectories = Arrays.asList(trajectory1);// , trajectory2);//, trajectory3,
                                                                           // trajectory4, trajectory5);

                // Trajectory finalTrajectory =
                // trajectory1.concatenate(trajectory2).concatenate(trajectory3).concatenate(trajectory4).concatenate(trajectory5);
                ...
                // Add commands for each trajectory with a delay between them ( I tried to make
                // this user friendly :> )
                for (Trajectory trajectory : trajectories) {
                         ...
                         * a = new InstantCommand(() ->
                         * arm.setPivotTargetAngle(ArmConstants.PICK_UP_ANGLE));
                         * b = new InstantCommand(() ->
                         * intake.setPivotTargetAngle(WristConstants.PICK_UP_ANGLE));
                         * c = new WaitCommand(1.5);
                         * //completes trajectory
                         * d = new WaitCommand(0);
                         * e = new InstantCommand(() -> intake.vacuum(0));
                         * f = new InstantCommand(() ->
                         * arm.setPivotTargetAngle(ArmConstants.LOAD_SHOOTER_ANGLE));
                         * g = new InstantCommand(() ->
                         * intake.setPivotTargetAngle(WristConstants.FEED_ANGLE));
                         * h = new WaitCommand(0);
                         * i = new WaitCommand(0);
                         * j = new WaitCommand(0);
                         * k = new WaitCommand(0);
                        ...
                        commandGroup.addCommands(
                                        ...
                                        new SwerveControllerCommand(
                                                        trajectory, // TODO: Idea! To lock heading of robot while
                                                                    // driving a trajectory, create an InstantCommand
                                                                    // that sets the Ptheta PID variable to 0, then
                                                                    // reinstate the value at a later time in the
                                                                    // trajectory
        ...
        public Command getBlueMid3HighAutonomousCommand() {
                ...
                String trajectoryJSON1 = "paths/BL Score High#1.wpilib.json"; // TODO: create Mid auton and replace BL
                                                                              // paths
                ...
                // String trajectoryJSON5 = "output/Return to Start (Prepare
                // Tele-Op).wpilib.json";
                // String trajectoryJSON6 = "output/Grab Close #2.wpilib.json";
                Trajectory trajectory1 = new Trajectory();
                Trajectory trajectory2 = new Trajectory();
        ...
        public Command getRedLeft3HighAutonomousCommand() {
                ...
                List<Trajectory> trajectories = Arrays.asList(trajectory1, trajectory2, trajectory3, trajectory4,
                                trajectory5);
        ...
        public Command getShootOnlyAutonomousCommand() {
                return new SequentialCommandGroup(
                                new WaitCommand(0.5),
                                new InstantCommand(() -> intake.feed(1)),
                                new WaitCommand(0.55),
                                new InstantCommand(() -> intake.feed(0)),
                                new InstantCommand(() -> flyWheel.shoot(1)),
                                new WaitCommand(1.25),
                                new InstantCommand(() -> intake.vacuum(1)),
                                new WaitCommand(1),
                                new InstantCommand(() -> flyWheel.shoot(0)),
                                new InstantCommand(() -> intake.vacuum(0)));
        }
}
